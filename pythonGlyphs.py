...
from bitcointx.core.script import OP_RETURN, OP_13
...
def main():
    """Parses command-line arguments and interacts with the GlyphProtocol."""
    parser = argparse.ArgumentParser(description='Glyphs Command Line Interface.')
